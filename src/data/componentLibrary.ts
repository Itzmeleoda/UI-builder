...
export const COMPONENT_LIBRARY: Record<ComponentType, ComponentDefinition> = {
  ...
  navbar: {
    ...
    defaultParams: {
      ...
      ctaTextColor: "#ffffff",
      ctaAction: { type: "none", url: "", target: "_self", componentId: "", message: "", code: "" },
      sticky: true,
    ...
    fields: [
      ...
      { key: "links", label: "Nav links (Label::URL)", type: "list", group: "content", help: "One per line. Add ::https://… to make a link live." },
      ...
      { key: "ctaAction", label: "CTA click action", type: "action", group: "behavior" },
  ...
  footer: {
    ...
    fields: [
      ...
      { key: "columns", label: "Columns (Title::links)", type: "list", group: "content", help: "One per line: Title::link1, link2. Add |https://… to a link to make it live." },
      { key: "background", label: "Background", type: "color", group: "style" },
  ...
  hero: {
    ...
    defaultParams: {
      ...
      primaryAction: { type: "none", url: "", target: "_self", componentId: "", message: "", code: "" },
      secondaryAction: { type: "none", url: "", target: "_self", componentId: "", message: "", code: "" },
    ...
    fields: [
      ...
      { key: "primaryAction", label: "Primary CTA action", type: "action", group: "behavior" },
      { key: "secondaryAction", label: "Secondary CTA action", type: "action", group: "behavior" },
  ...
  searchBar: {
    ...
    defaultParams: {
      ...
      suggestions: ["Components", "Templates", "Assets", "Settings", "Export"],
      textFont: "system-ui, -apple-system, 'Segoe UI', sans-serif",
      durationMs: 150,
      easing: "ease-out",
      trigger: "click",
    ...
    fields: [
      ...
      { key: "suggestions", label: "Suggestions", type: "list", group: "content" },
      ...textStyleFields(),
      ...motionFields(),
    ],
    signature: {
  ...
  button: {
    ...
    defaultParams: {
      ...
      fontWeight: 600,
      textFont: "system-ui, -apple-system, 'Segoe UI', sans-serif",
      action: { type: "none", url: "", target: "_self", componentId: "", message: "", code: "" },
      durationMs: 150,
      easing: "ease-out",
      trigger: "hover",
    ...
    fields: [
      ...
      { key: "action", label: "Click action", type: "action", group: "behavior" },
  ...
  modal: {
    ...
    fields: [
      ...
      { key: "borderRadius", label: "Radius (px)", type: "range", group: "style", min: 0, max: 48 },
      { key: "triggerLabel", label: "Trigger button label", type: "text", group: "content" },
  ...
  card: {
    ...
    fields: [
      ...
      { key: "action", label: "Click action (on reveal)", type: "action", group: "behavior" },
  ...
  newsletter: {
    ...
    fields: [
      ...
      { key: "action", label: "Action after submit", type: "action", group: "behavior" },
  ...
  breadcrumb: {
    ...
    fields: [
      { key: "items", label: "Items (Label::URL)", type: "list", group: "content", help: "One per line. Add ::https://… to link an item." },
